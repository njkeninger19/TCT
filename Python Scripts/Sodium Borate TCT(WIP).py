...
for R in i:
    ...
    if .7 <= R <= 1:
        ...
        m3 = 1 - (b3+d3+t3+dp3+dt3+n4)
        co3 = 0
    if 1 < R < 1.5 + (.3/1.7)*(1.5-1.3):
        if co3 < 0:
            co3 = 0
        R = R-co3 # fraction of the glass dedicated to borate network (rest goes to carbonate)
        n4 = -13/60*R + 13/24
        o3 = 0
        b3 = 0
        d3 = 0
    ...
    if 1.5 + (.3/1.7)*(1.5-1.3) <= R <= 2 + (.3/1.7)*(2-1.3):
        co3 = (.3/1.7)*(R-1.3)
        r = (R-co3)/R
        #R = R-co3 # fraction of the glass dedicated to borate network (rest goes to carbonate)
        n4 = -13/60*R + 13/24
        ...
        o3_R_2 = o3
        m3_R_2 = m3
    if 2 + (.3/1.7)*(2-1.3) < R < 2.5 + (.3/1.7)*(2.5-1.3):
        co3 = (.3/1.7)*(R-1.3)
        R = R-co3 # fraction of the glass dedicated to borate network (rest goes to carbonate)
        n4 = -13/60*R + 13/24
        b3 = 0
        ...
        l4 = 0
        p3 = (1/3*(R-1))
        m3 = (-(m3_R_2/.5)*(R-2.5)) #(-0.4159*R + 1.0397)*r#
        dp4 = (17/53*(n4-l4))
        dp3 = 1.5*dp4
        dt4 = 36/17*dp4
        dt3 = dt4/2
        o3 = (((.5 - o3_R_2)/(2.5 - 2))*(R-2.5) + .5)
    if 2.5 + (.3/1.7)*(2.5-1.3) <= R < 3:
        co3 = (.3/1.7)*(R-1.3)
        R = R-co3
        n4 = 0
        b3 = 0
...
def TgPlot():
    ...
    plt.plot(i, TgnC, '-',  color = "yellow", label = "Tg Model")
